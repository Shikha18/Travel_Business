...
export type JourneyPricing = {
  ...
  priceUSD: number;    // per person in USD (primary display currency)
...
export type Journey = {
  ...
  inclusions: string[];
  exclusions: string[];
  travelTips: string[];    // practical notes for international travelers — visa, plugs, dietary, climate
...
export const journeys: Journey[] = [
  // ─── GOLDEN TRIANGLE, PUSHKAR & VARANASI ──────────────────────────────
  {
    ...
    title: "Golden Triangle, Ranthambore, Pushkar & Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — the classic circuit plus a tiger reserve, a desert lake and the oldest city on Earth",
    ...
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar & Varanasi, North India",
    durationNights: 11,
    durationDays: 12,
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (optional) → Delhi",
    routeStops: [{ name: "Delhi", lat: 28.6139, lng: 77.209 }, { name: "Agra", lat: 27.1767, lng: 78.0081 }, { name: "Ranthambore", lat: 26.0173, lng: 76.3520 }, { name: "Jaipur", lat: 26.9124, lng: 75.7873 }, { name: "Pushkar", lat: 26.4899, lng: 74.5511 }, { name: "Delhi", lat: 28.6139, lng: 77.209 }, { name: "Varanasi", lat: 25.3176, lng: 82.9739 }, { name: "Delhi", lat: 28.6139, lng: 77.209 }],
    months: ["October", "November", "December", "January", "February", "March"],
    groupSize: "Max 10 travelers",
    difficulty: "Easy",
    summary:
      "The Taj Mahal at sunrise, two full jeep safaris tracking tigers through Ranthambore's forests and ruined fort, a Rajput fortress rising from a lake, a 1,200-year-old stepwell carved into the earth, camels crossing dunes at a holy desert lake, and — for those who add it on — the oldest continuously inhabited city on Earth. Twelve days built specifically for first-time visitors to India, with every travel leg, monument fee, safari and opening time checked in advance.",
    overview:
      "This is the itinerary we build most often for first-time travelers from Europe and North America, because it answers the question 'what should I actually see in twelve days?' without cramming or rushing. It starts with the Golden Triangle — Delhi, Agra, Jaipur — India's essential introduction, with a detour south from Agra to Ranthambore, one of India's best tiger reserves, for a full day of two jeep safaris before continuing on to Jaipur. From there we turn southwest to Pushkar, a small holy town on a sacred lake that most first-timers never reach and almost always call the highlight of the trip. From Pushkar we loop back to Delhi and, for guests who want it, fly onward to Varanasi — the oldest living city on Earth, where the Ganges runs between the world of the living and the world beyond it. We move entirely by private air-conditioned vehicle between Delhi, Agra, Ranthambore, Jaipur and Pushkar (with realistic drive times built into each day, not the 'optimistic' numbers some operators quote), and by short domestic flight between Delhi and Varanasi rather than an 8+ hour train, because on a twelve-day trip your time is the scarcest resource. Every monument visit and safari in this itinerary is timed against its actual opening hours, safari shift and current entry fee for foreign nationals — sunrise at the Taj before the ticket queues form, dawn and afternoon safari shifts in Ranthambore, Amber Fort before the midday heat, the Ganga Aarti at the hour it's actually performed. Shikha or a GoTrustelle host is reachable throughout, and the whole trip is designed around the questions European and American travelers ask most: is it safe, what do I eat, what do I wear, and how do I get from A to B without losing a day to traffic. We run this itinerary October through March, when daytime temperatures are comfortable for both sightseeing and safari and Ranthambore's dry, thinned-out forest makes tiger sightings far more likely than in the hotter months.",
    highlights: [
      "Taj Mahal at sunrise — 30 minutes with the marble to yourself before the crowds arrive",
      "Ranthambore National Park — two jeep safaris in one of India's premier tiger reserves, tracking tigers, leopards and sloth bears past the ruins of a 10th-century fort",
      ...
      "Pushkar Camel Fair (14–24 November departure only) — Rajasthan's biggest folk festival, thousands of camels, traders and performers on the lake's edge",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "Taj Mahal at sunrise — Agra → Ranthambore",
        description:
          "Early start: the Taj Mahal opens 30 minutes before sunrise (ticket counters open an hour before), and this first half-hour — soft light, thin crowds — is the reason we build the whole trip around it (foreign entry ₹1,100, plus ₹200 for the inner mausoleum; children under 15 free; closed every Friday, in which case this visit shifts to Day 3 afternoon instead). After breakfast, depart for Ranthambore (approx. 280 km, 5–5.5 hours, with a lunch stop en route), checking into your jungle lodge on the edge of the national park by mid-to-late afternoon. If arrival timing allows, straight into an evening jeep safari — an open 6-seater gypsy with a naturalist guide heads into the park for the evening shift (national park entry and safari fees included; zone assigned by the forest department) — tigers, spotted deer and the ruined ramparts of Ranthambore Fort inside the park, in the same golden light that made the Taj glow that morning.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Sunrise at the Taj, evening jeep safari in tiger territory — two very different Indias in one day",
      },
      {
        day: 5,
        title: "Ranthambore National Park — dawn & afternoon jeep safaris",
        description:
          "A full day built around Ranthambore's two safari shifts, each in an open 6-seater gypsy with a naturalist guide (zone assigned by the forest department each day; national park entry and safari fees included). The dawn safari catches the park waking up — langurs calling, sambar and spotted deer at the lakes, and the best chance of the day for a tiger sighting as they move before the heat sets in. Between safaris, rest at the lodge or, if timing allows, a look at Ranthambore Fort, a 10th-century hill fort still standing inside the reserve with resident tigers sometimes seen from its walls. The afternoon safari heads into a different zone, with a good chance of sightings of sloth bears, marsh crocodiles and, with some luck, one of the park's resident tigers. Tiger sightings are common here but never guaranteed — we brief you honestly on the odds before you book.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Two jeep safaris in one of India's best tiger reserves — dawn and afternoon shifts",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur via the Abhaneri stepwell",
        description:
          "A relaxed late-morning departure from Ranthambore for Jaipur (approx. 220 km via Abhaneri, 4.5–5 hours), breaking the drive at Abhaneri to see Chand Baori — the 1,200-year-old stepwell locals call the 'baori ki haveli', its 3,500 steps descending 13 storeys in perfect geometric symmetry (foreign entry approx. ₹300; open daily 8 AM–6 PM). Arrive in Jaipur by early evening and check into your heritage haveli hotel, with the evening free to explore Johari Bazaar's jewellery and textile stalls.",
      ...
      },
      {
        ...
        title: "Departure",
        description:
          "A relaxed final morning before your transfer to Delhi's international airport. Our team confirms your onward flight details in advance and stays reachable until you're checked in. You leave carrying the Taj at sunrise, tigers in Ranthambore, a stepwell unlike anything at home, camels on a desert lake, and — if you added the extension — the oldest city on Earth still burning its eternal fire on the riverbank.",
        overnight: "—",
        highlight: "One last coffee before the airport — twelve days, condensed into everything you needed to see",
      },
    ],
    inclusions: [
      "11 nights accommodation: 2× boutique hotel Delhi + 1× boutique hotel Agra + 2× jungle lodge Ranthambore + 2× heritage haveli hotel Jaipur + 1× heritage guesthouse Pushkar + 2× heritage hotel Varanasi + 1× hotel near Delhi airport (twin-sharing)",
      "Private AC vehicle for all sightseeing and road transfers (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      "Domestic return flights Delhi ↔ Varanasi",
      "Professional licensed guide in each city",
      "Taj Mahal sunrise guided visit",
      "2 shared jeep (gypsy) safaris in Ranthambore National Park with naturalist guide, including national park entry and safari fees",
      "Chand Baori (Abhaneri stepwell) stop on the Ranthambore–Jaipur drive",
    ...
    exclusions: [
      ...
      "Private (non-shared) gypsy safari upgrade in Ranthambore (optional, approx. ₹3,000–5,000 extra per vehicle per safari)",
      ...
      "Elephant/jeep-up option at Amber Fort or camel rides beyond what's listed",
    ...
    travelTips: [
      ...
      "Ranthambore safari zones and jeep/canter allocation are assigned by the forest department each day, not by us or the lodge — while sightings are common, a tiger encounter can never be guaranteed. Wear muted, neutral-colored clothing for the safaris (no bright colors or white)",
      "This itinerary runs October through March — Ranthambore's forest thins out and cools down in this window, making tiger sightings noticeably more likely than in the hot, dense pre-monsoon months",
      "The Pushkar–Delhi road leg (Day 9) is a long one (7.5–8 hours) — we start early and build in a proper lunch stop; travelers who'd rather skip it can end the trip in Delhi on Day 8 evening and fly home from there",
      "The Varanasi extension (Days 9–11) is optional — let us know at booking if you'd prefer a 9-day Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi trip instead, and we'll adjust pricing and flights accordingly",
      ...
      "Early-morning safari jeeps in Ranthambore and December/January mornings in Delhi/Agra can be cold (5–10°C at dawn) — pack a proper warm layer, gloves and a hat for the safari",
    ],
    pricing: [
      { label: "Twin sharing — Standard, with Varanasi (from Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Twin sharing — Premium, with Varanasi (from Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Twin sharing — Standard, without Varanasi, 9 days (from Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    featured: true,
    departures: [
      "October 17 – 27, 2026 (fixed group departure)",
      "November 14 – 24, 2026 (fixed group departure — Pushkar Camel Fair Special)",
      "November 28 – December 8, 2026 (fixed group departure)",
      "December 19 – 29, 2026 (fixed group departure)",
      "January 16 – 26, 2027 (fixed group departure)",
      "February 13 – 23, 2027 (fixed group departure)",
      "March 13 – 23, 2027 (fixed group departure)",
...

  {
    ...
    pricing: [
      { label: "Deluxe (6 pax)", priceUSD: 1899, priceINR: 185000 },
      { label: "Premium (6 pax)", priceUSD: 1999, priceINR: 195900 },
      { label: "Royal (6 pax)", priceUSD: 2099, priceINR: 206700 },
    ],
    featured: true,
...

  {
    ...
    exclusions: [
      "Return flights Delhi ↔ Leh (book early — typically $90–170 per sector; we assist with booking on request)",
    ...
    pricing: [
      { label: "Twin sharing — Deluxe (from Leh)", priceUSD: 2499, priceINR: 239400 },
      { label: "Twin sharing — Premium (from Leh)", priceUSD: 2799, priceINR: 272100 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },  // ─── LADAKH DARK SKY CIRCUIT ─────────────────────────────────────────
  {
    ...
    exclusions: [
      "Return flights Delhi ↔ Leh (book early — approx. $90–170 per sector; we assist on request)",
...

  {
    ...
    pricing: [
      { label: "Twin / Triple sharing (from Shimla)", priceUSD: 1899, priceINR: 185000 },
      { label: "Twin / Triple sharing (from Delhi)", priceUSD: 1999, priceINR: 195900 },
      { label: "Double occupancy (from Delhi)", priceUSD: 1999, priceINR: 195900 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },

  {
    ...
    exclusions: [
      "International or domestic flights to/from Delhi",
      "Lunches during the tour (we recommend trusted local restaurants — budget ~$9–14 per meal)",
    ...
    pricing: [
      { label: "Twin sharing — Premium (from Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Twin sharing — Standard (from Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },
  ...
  // ─── NORTHEAST INDIA ─────────────────────────────────────────────────
  {
    ...
    exclusions: [
      "Return flights Delhi ↔ Guwahati (approx. $70–115 per sector; we assist with booking on request)",
    ...
    pricing: [
      { label: "Twin sharing (from Guwahati)", priceUSD: 2099, priceINR: 206700 },
      { label: "Twin sharing (from Delhi)", priceUSD: 2399, priceINR: 228500 },
    ],
    featured: false,
    departures: ["Customisable — contact us"],
  },
  ...
  // ─── BIR ITINERARY ───────────────────────────────────────────────────
  {
    ...
    pricing: [
      { label: "Per person (small group)", priceUSD: 1499, priceINR: 141400 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },
  ...
  // ─── VALLEY OF FLOWERS ───────────────────────────────────────────────
  {
    ...
    pricing: [
      { label: "Twin sharing (from Delhi)", priceUSD: 1399, priceINR: 130500 },
      { label: "Twin sharing — Premium (from Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },
  ...
  // ─── KERALA ESCAPE ───────────────────────────────────────────────────
  {
    ...
    pricing: [
      { label: "Twin sharing — Standard (from Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Twin sharing — Premium (from Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
    featured: true,
    departures: ["Customisable — contact us"],
  },
...
const journeysDeOverrides: JourneyOverrideMap = {
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Doppelzimmer — Standard (ab Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Doppelzimmer — Premium (ab Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  "golden-triangle-pushkar-varanasi": {
    title: "Goldenes Dreieck, Ranthambore, Pushkar & Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — die klassische Route plus ein Tigerreservat, ein Wüstensee und die älteste Stadt der Welt",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar & Varanasi, Nordindien",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (optional) → Delhi",
    groupSize: "Max. 10 Reisende",
    difficulty: "Easy",
    summary:
      "Der Taj Mahal bei Sonnenaufgang, zwei volle Jeep-Safari-Schichten auf Tigersuche in den Wäldern und der Festungsruine von Ranthambore, eine Rajput-Festung über einem See, eine 1.200 Jahre alte Stufenbrunnenanlage, tief in die Erde geschnitten, Kamele, die Dünen an einem heiligen Wüstensee durchqueren, und — für alle, die sie dazunehmen — die älteste durchgehend bewohnte Stadt der Welt. Zwölf Tage, konzipiert speziell für Indien-Erstbesucher, bei denen jede Fahrtstrecke, jede Eintrittsgebühr, jede Safari und jede Öffnungszeit vorab geprüft wurde.",
    overview:
      "Das ist die Reiseroute, die wir am häufigsten für Erstbesucher aus Europa und Nordamerika zusammenstellen, denn sie beantwortet die Frage 'Was sollte ich in zwölf Tagen wirklich sehen?', ohne zu hetzen oder zu überladen. Sie beginnt mit dem Goldenen Dreieck — Delhi, Agra, Jaipur — Indiens wichtigster Einführung, mit einem Abstecher von Agra nach Süden zum Ranthambore-Nationalpark, einem der besten Tigerreservate Indiens, für einen ganzen Tag mit zwei Jeep-Safaris, bevor es weiter nach Jaipur geht. Von dort wendet sich die Reise nach Südwesten nach Pushkar, einer kleinen heiligen Stadt an einem heiligen See, die die meisten Erstbesucher nie erreichen und die fast immer als Highlight der Reise bezeichnet wird. Von Pushkar aus schließt sich die Schleife zurück nach Delhi, und für Gäste, die es möchten, fliegen wir weiter nach Varanasi — der ältesten noch bewohnten Stadt der Welt, wo der Ganges zwischen der Welt der Lebenden und der Welt danach fließt. Wir bewegen uns zwischen Delhi, Agra, Ranthambore, Jaipur und Pushkar ausschließlich in einem privaten klimatisierten Fahrzeug (mit realistischen Fahrzeiten für jeden Tag, nicht den 'optimistischen' Zahlen mancher Anbieter) und zwischen Delhi und Varanasi mit einem kurzen Inlandsflug statt einer über achtstündigen Zugfahrt — denn bei einer zwölftägigen Reise ist Ihre Zeit die knappste Ressource. Jeder Besuch eines Denkmals und jede Safari in dieser Reiseroute ist an die tatsächlichen Öffnungszeiten, Safari-Schichten und die aktuelle Eintrittsgebühr für ausländische Staatsangehörige angepasst — Sonnenaufgang am Taj, bevor sich die Ticketschlangen bilden, Morgen- und Nachmittags-Safarischichten in Ranthambore, das Amber Fort vor der Mittagshitze, die Ganga Aarti zur Stunde, zu der sie wirklich zelebriert wird. Shikha oder ein GoTrustelle-Gastgeber sind durchgehend erreichbar, und die gesamte Reise ist um die Fragen herum gestaltet, die europäische und amerikanische Reisende am häufigsten stellen: Ist es sicher, was esse ich, was ziehe ich an, und wie komme ich von A nach B, ohne einen Tag im Verkehr zu verlieren. Wir führen diese Reise von Oktober bis März durch, wenn die Tagestemperaturen sowohl für Besichtigungen als auch für Safaris angenehm sind und der trockene, lichtere Wald in Ranthambore Tigersichtungen deutlich wahrscheinlicher macht als in den heißeren Monaten.",
    highlights: [
      "Taj Mahal bei Sonnenaufgang — 30 Minuten mit dem Marmor ganz für sich allein, bevor die Menschenmengen eintreffen",
      "Ranthambore-Nationalpark — zwei Jeep-Safaris in einem der besten Tigerreservate Indiens, auf der Suche nach Tigern, Leoparden und Lippenbären an den Ruinen einer Festung aus dem 10. Jahrhundert",
      ...
      "Pushkar-Kamelmesse (nur Abreise 14.–24. November) — Rajasthans größtes Volksfest, Tausende Kamele, Händler und Künstler am Ufer des Sees",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "Taj Mahal bei Sonnenaufgang — Agra → Ranthambore",
        description:
          "Früher Start: Der Taj Mahal öffnet 30 Minuten vor Sonnenaufgang (die Ticketschalter eine Stunde davor), und diese erste halbe Stunde — weiches Licht, wenige Besucher — ist der Grund, warum wir die ganze Reise darum herum aufbauen (Eintritt für Ausländer ₹1.100, plus ₹200 für das innere Mausoleum; Kinder unter 15 Jahren frei; freitags geschlossen, in diesem Fall verschieben wir den Besuch auf den Nachmittag von Tag 3). Nach dem Frühstück Abfahrt nach Ranthambore (ca. 280 km, 5–5,5 Stunden, mit Mittagspause unterwegs), Check-in in Ihrer Jungle-Lodge am Rand des Nationalparks am frühen bis späten Nachmittag. Wenn die Ankunftszeit es zulässt, direkt weiter zu einer abendlichen Jeep-Safari: ein offener 6-Sitzer-Jeep mit Naturführer fährt in den Park für die Abendschicht (Nationalpark-Eintritt und Safari-Gebühren inklusive; die Zone wird von der Forstbehörde zugewiesen) — Tiger, Axishirsche und die Ruinen der Ranthambore-Festung im Park, im selben goldenen Licht, das am Morgen den Taj zum Leuchten brachte.",
        overnight: "Jungle-Lodge, Ranthambore",
        highlight: "Sonnenaufgang am Taj, abendliche Jeep-Safari in Tigergebiet — zwei sehr unterschiedliche Seiten Indiens an einem Tag",
      },
      {
        day: 5,
        title: "Ranthambore-Nationalpark — Jeep-Safaris im Morgengrauen & am Nachmittag",
        description:
          "Ein ganzer Tag rund um die beiden Safari-Schichten von Ranthambore, jeweils in einem offenen 6-Sitzer-Jeep mit Naturführer (die Zone wird jeden Tag von der Forstbehörde zugewiesen; Nationalpark-Eintritt und Safari-Gebühren inklusive). Die Morgen-Safari erlebt den Park beim Erwachen — rufende Langurschwänze, Sambar- und Axishirsche an den Seen, und die beste Chance des Tages auf eine Tigersichtung, während sie sich vor der Hitze bewegen. Zwischen den Safaris Erholung in der Lodge oder, wenn die Zeit es zulässt, ein Besuch der Ranthambore-Festung, einer noch stehenden Bergfestung aus dem 10. Jahrhundert innerhalb des Reservats, von deren Mauern manchmal ansässige Tiger zu sehen sind. Die Nachmittags-Safari führt in eine andere Zone, mit guten Chancen auf Sichtungen von Lippenbären, Sumpfkrokodilen und mit etwas Glück einem der ansässigen Tiger des Parks. Tigersichtungen sind hier häufig, aber nie garantiert — wir informieren Sie ehrlich über die Chancen, bevor Sie buchen.",
        overnight: "Jungle-Lodge, Ranthambore",
        highlight: "Zwei Jeep-Safaris in einem der besten Tigerreservate Indiens — Morgen- und Nachmittagsschicht",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur über die Stufenbrunnenanlage von Abhaneri",
        description:
          "Eine entspannte Abfahrt am späten Vormittag von Ranthambore nach Jaipur (ca. 220 km über Abhaneri, 4,5–5 Stunden), mit einem Stopp in Abhaneri, um Chand Baori zu sehen — die 1.200 Jahre alte Stufenbrunnenanlage, die Einheimische 'Baori ki Haveli' nennen, deren 3.500 Stufen sich in perfekter geometrischer Symmetrie 13 Stockwerke tief hinabziehen (Eintritt für Ausländer ca. ₹300; täglich geöffnet 8–18 Uhr). Ankunft in Jaipur am frühen Abend und Check-in in Ihrem historischen Haveli-Hotel, der Abend steht frei für einen Bummel durch die Schmuck- und Textilstände des Johari Bazaar.",
      ...
      },
      {
        ...
        title: "Abreise",
        description:
          "Ein entspannter letzter Morgen vor dem Transfer zum internationalen Flughafen von Delhi. Unser Team bestätigt Ihre Weiterflugdetails im Voraus und bleibt erreichbar, bis Sie eingecheckt haben. Sie reisen mit dem Taj bei Sonnenaufgang, Tigern in Ranthambore, einer Stufenbrunnenanlage wie keiner zu Hause, Kamelen an einem Wüstensee und — falls Sie die Verlängerung dazugenommen haben — der ältesten Stadt der Welt, die ihr ewiges Feuer noch immer am Flussufer brennt.",
        overnight: "—",
        highlight: "Ein letzter Kaffee vor dem Flughafen — zwölf Tage, verdichtet auf alles, was Sie sehen wollten",
      },
    ],
    inclusions: [
      "11 Übernachtungen: 2× Boutique-Hotel Delhi + 1× Boutique-Hotel Agra + 2× Jungle-Lodge Ranthambore + 2× historisches Haveli-Hotel Jaipur + 1× historisches Gästehaus Pushkar + 2× historisches Hotel Varanasi + 1× Hotel in Flughafennähe Delhi (Doppelzimmer)",
      "Privates klimatisiertes Fahrzeug für alle Besichtigungen und Straßentransfers (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 gemeinsame Jeep-Safaris (Gypsy) im Ranthambore-Nationalpark mit Naturführer, inklusive Nationalpark-Eintritt und Safari-Gebühren",
      "Stopp an Chand Baori (Stufenbrunnenanlage Abhaneri) auf der Fahrt Ranthambore–Jaipur",
    ...
    exclusions: [
      ...
      "Privates (nicht geteiltes) Gypsy-Safari-Upgrade in Ranthambore (optional, ca. ₹3.000–5.000 zusätzlich pro Fahrzeug und Safari)",
      "Kashi Vishwanath Sugam/VIP-Darshan (optional, ca. ₹250)",
      "Mittagessen während der Reise (Budget ₹500–800 pro Mahlzeit)",
      "Persönliche Ausgaben: Einkäufe, Trinkgelder, Getränke",
      "Elefanten-/Jeep-Option am Amber Fort oder Kamelritte über das Aufgeführte hinaus",
      "Reise- und Krankenversicherung (dringend empfohlen)",
      "5% GST auf den gesamten Paketpreis",
    ],
    pricing: [
      { label: "Doppelzimmer — Standard, mit Varanasi (ab Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Doppelzimmer — Premium, mit Varanasi (ab Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Doppelzimmer — Standard, ohne Varanasi, 9 Tage (ab Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17. – 27. Oktober 2026 (feste Gruppenabreise)",
      "14. – 24. November 2026 (feste Gruppenabreise — Pushkar-Kamelmesse-Spezial)",
      "28. November – 8. Dezember 2026 (feste Gruppenabreise)",
      "19. – 29. Dezember 2026 (feste Gruppenabreise)",
      "16. – 26. Januar 2027 (feste Gruppenabreise)",
      "13. – 23. Februar 2027 (feste Gruppenabreise)",
      "13. – 23. März 2027 (feste Gruppenabreise)",
  ...
  "spiti-summer-expedition": {
    ...
    pricing: [
      { label: "Twin / Triple-Sharing (ab Shimla)", priceUSD: 2499, priceINR: 239400 },
      { label: "Twin / Triple-Sharing (ab Delhi)", priceUSD: 2799, priceINR: 272100 },
      { label: "Doppelzimmer (ab Delhi)", priceUSD: 2999, priceINR: 293800 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  ...
  "paradise-of-kashmir": {
    ...
    pricing: [
      { label: "Deluxe (6 Personen)", priceUSD: 2399, priceINR: 228500 },
      { label: "Premium (6 Personen)", priceUSD: 2799, priceINR: 272100 },
      { label: "Royal (6 Personen)", priceUSD: 3299, priceINR: 315600 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  ...
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      "Internationale oder inländische Flüge nach/von Delhi",
      "Mittagessen während der Reise (wir empfehlen vertrauenswürdige Lokalrestaurants — ca. $9–14 pro Mahlzeit)",
    ...
    pricing: [
      { label: "Twin-Sharing — Premium (ab Delhi)", priceUSD: 1599, priceINR: 152300 },
      { label: "Twin-Sharing — Standard (ab Delhi)", priceUSD: 1399, priceINR: 130500 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  ...
  "ladakh-grand-circuit": {
    ...
    exclusions: [
      "Hin- und Rückflüge Delhi ↔ Leh (frühzeitig buchen — typischerweise $90–170 pro Strecke; auf Anfrage helfen wir beim Buchen)",
    ...
    pricing: [
      { label: "Twin-Sharing — Deluxe (ab Leh)", priceUSD: 2499, priceINR: 239400 },
      { label: "Twin-Sharing — Premium (ab Leh)", priceUSD: 2899, priceINR: 283000 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  ...
  "ladakh-dark-sky-circuit": {
    ...
    exclusions: [
      "Hin- und Rückflüge Delhi ↔ Leh (ca. $90–170 pro Strecke; auf Anfrage helfen wir beim Buchen)",
    ...
    pricing: [
      { label: "Twin-Sharing — Deluxe (ab Leh)", priceUSD: 2499, priceINR: 239400 },
      { label: "Twin-Sharing — Premium (ab Leh)", priceUSD: 2799, priceINR: 272100 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
  ...
  "northeast-india-meghalaya": {
    ...
    exclusions: [
      "Hin- und Rückflüge Delhi ↔ Guwahati (ca. $70–115 pro Strecke; auf Anfrage helfen wir beim Buchen)",
    ...
    pricing: [
      { label: "Twin-Sharing (ab Guwahati)", priceUSD: 2099, priceINR: 206700 },
      { label: "Twin-Sharing (ab Delhi)", priceUSD: 2399, priceINR: 228500 },
    ],
    departures: ["Individuell — Anfrage stellen"],
  },
};
...
const journeysFrOverrides: JourneyOverrideMap = {
  "northeast-india-meghalaya": {
    ...
    exclusions: [
      "Vols aller-retour Delhi ↔ Guwahati (environ 70 à 115 $ par trajet ; nous vous aidons à réserver sur demande)",
    ...
    pricing: [
      { label: "Chambre double (depuis Guwahati)", priceUSD: 2099, priceINR: 206700 },
      { label: "Chambre double (depuis Delhi)", priceUSD: 2399, priceINR: 228500 },
    ],
  ...
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Chambre double — Standard (depuis Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Chambre double — Premium (depuis Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
    departures: ["Sur mesure — contactez-nous"],
  },
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      ...
      "Déjeuners pendant le circuit (nous recommandons des restaurants locaux de confiance — prévoir environ 9 à 14 $ par repas)",
    ...
    pricing: [
      { label: "Chambre double — Premium (départ de Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Chambre double — Standard (départ de Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    departures: ["Sur mesure — contactez-nous"],
  },
  "paradise-of-kashmir": {
    ...
    pricing: [
      { label: "Deluxe (6 pers.)", priceUSD: 1899, priceINR: 185000 },
      { label: "Premium (6 pers.)", priceUSD: 1999, priceINR: 195900 },
      { label: "Royal (6 pers.)", priceUSD: 2099, priceINR: 206700 },
    ],
    departures: ["Sur mesure — contactez-nous"],
  },
  "golden-triangle-pushkar-varanasi": {
    title: "Triangle d'Or, Ranthambore, Pushkar & Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — le circuit classique complété par une réserve de tigres, un lac du désert et la plus vieille ville du monde",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar & Varanasi, Inde du Nord",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (optionnel) → Delhi",
    groupSize: "Max 10 voyageurs",
    difficulty: "Easy",
    summary:
      "Le Taj Mahal au lever du soleil, deux safaris en jeep à la recherche des tigres dans les forêts et la forteresse en ruines de Ranthambore, une forteresse rajpoute dominant un lac, un puits à degrés vieux de 1 200 ans creusé dans la terre, des chameaux traversant les dunes d'un lac sacré du désert et, pour ceux qui l'ajoutent, la plus ancienne ville habitée sans interruption au monde. Douze jours conçus spécifiquement pour les voyageurs qui découvrent l'Inde pour la première fois, avec chaque trajet, chaque tarif de monument, chaque safari et chaque horaire d'ouverture vérifiés à l'avance.",
    overview:
      "C'est l'itinéraire que nous construisons le plus souvent pour les voyageurs européens et nord-américains qui découvrent l'Inde, car il répond à la question 'que dois-je vraiment voir en douze jours ?' sans se presser ni tout entasser. Il commence par le Triangle d'Or — Delhi, Agra, Jaipur — l'introduction essentielle à l'Inde, avec un détour au sud d'Agra vers Ranthambore, l'une des meilleures réserves de tigres d'Inde, pour deux safaris en jeep avant de poursuivre vers Jaipur. De là, nous nous dirigeons vers le sud-ouest jusqu'à Pushkar, une petite ville sainte au bord d'un lac sacré que la plupart des premiers visiteurs n'atteignent jamais et qu'ils qualifient presque toujours de point fort du voyage. Depuis Pushkar, nous rejoignons Delhi et, pour les voyageurs qui le souhaitent, nous prenons un vol vers Varanasi — la plus ancienne ville vivante du monde, où le Gange coule entre le monde des vivants et celui de l'au-delà. Nous nous déplaçons entièrement en véhicule privé climatisé entre Delhi, Agra, Ranthambore, Jaipur et Pushkar (avec des temps de route réalistes intégrés à chaque journée, et non les chiffres 'optimistes' de certains opérateurs), et par un court vol intérieur entre Delhi et Varanasi plutôt qu'un train de plus de 8 heures, car sur un voyage de douze jours, votre temps est la ressource la plus précieuse. Chaque visite de monument et chaque safari de cet itinéraire sont programmés en fonction des horaires d'ouverture réels, des créneaux de safari et du tarif d'entrée actuel pour les ressortissants étrangers — lever du soleil au Taj avant la formation des files d'attente, créneaux de safari du matin et de l'après-midi à Ranthambore, le Fort d'Amber avant la chaleur de midi, la Ganga Aarti à l'heure où elle est réellement célébrée. Shikha ou un hôte GoTrustelle reste joignable tout au long du voyage, et l'ensemble du séjour est conçu autour des questions que se posent le plus souvent les voyageurs européens et américains : est-ce sûr, que vais-je manger, comment m'habiller, et comment aller d'un point à un autre sans perdre une journée dans les embouteillages. Nous organisons cet itinéraire d'octobre à mars, lorsque les températures diurnes sont agréables aussi bien pour les visites que pour les safaris, et que la forêt sèche et dégagée de Ranthambore rend les observations de tigres bien plus probables que pendant les mois les plus chauds.",
    highlights: [
      "Le Taj Mahal au lever du soleil — 30 minutes avec le marbre pour vous seuls, avant l'arrivée des foules",
      "Le Parc national de Ranthambore — deux safaris en jeep dans l'une des principales réserves de tigres d'Inde, à la recherche de tigres, de léopards et d'ours lippus parmi les ruines d'une forteresse du Xe siècle",
      ...
      "La Foire aux chameaux de Pushkar (départ du 14 au 24 novembre uniquement) — le plus grand festival populaire du Rajasthan, des milliers de chameaux, marchands et artistes au bord du lac",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "Le Taj Mahal au lever du soleil — Agra → Ranthambore",
        description:
          "Départ matinal : le Taj Mahal ouvre 30 minutes avant le lever du soleil (les guichets ouvrent une heure avant), et cette première demi-heure — lumière douce, foule clairsemée — est la raison pour laquelle nous construisons tout le voyage autour d'elle (entrée étrangers ₹1 100, plus ₹200 pour l'intérieur du mausolée ; gratuit pour les moins de 15 ans ; fermé tous les vendredis, auquel cas cette visite est déplacée à l'après-midi du jour 3). Après le petit-déjeuner, départ vers Ranthambore (environ 280 km, 5 à 5h30, avec un arrêt déjeuner en chemin), installation dans votre jungle-lodge en bordure du parc national en fin d'après-midi. Si l'horaire le permet, départ pour un premier safari en soirée : un jeep ouvert à 6 places avec un guide naturaliste entre dans le parc pour le créneau du soir (entrée du parc national et frais de safari inclus ; la zone est attribuée par les autorités forestières) — tigres, cerfs axis et les ruines de la forteresse de Ranthambore à l'intérieur du parc.",
        overnight: "Jungle-lodge, Ranthambore",
        highlight: "Lever du soleil au Taj, safari en soirée en territoire des tigres — deux visages très différents de l'Inde en une seule journée",
      },
      {
        day: 5,
        title: "Parc national de Ranthambore — safaris en jeep à l'aube et l'après-midi",
        description:
          "Une journée entière construite autour des deux créneaux de safari du parc, chacun dans un jeep ouvert à 6 places avec un guide naturaliste (la zone est attribuée chaque jour par les autorités forestières). Le safari de l'aube surprend le parc à son réveil — langurs, sambars et cerfs axis près des lacs, et les meilleures chances d'observer un tigre de la journée, alors qu'ils se déplacent encore avant l'arrivée de la chaleur. Entre les deux safaris, repos au lodge ou, si l'horaire le permet, visite de la forteresse de Ranthambore, une forteresse de collines du Xe siècle à l'intérieur de la réserve, depuis les remparts de laquelle on aperçoit parfois des tigres. Le safari de l'après-midi explore une zone différente — ours lippus, crocodiles des marais et, avec un peu de chance, un tigre. Les observations sont fréquentes ici mais, comme pour toute rencontre avec la faune sauvage, jamais garanties.",
        overnight: "Jungle-lodge, Ranthambore",
        highlight: "Deux safaris en jeep dans l'une des meilleures réserves de tigres d'Inde — créneaux de l'aube et de l'après-midi",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur via le puits à degrés d'Abhaneri",
        description:
          "Un départ tranquille en fin de matinée depuis Ranthambore vers Jaipur (environ 220 km via Abhaneri, 4h30 à 5h), avec une halte à Abhaneri pour voir Chand Baori — le puits à degrés vieux de 1 200 ans que les habitants appellent le 'baori ki haveli', dont les 3 500 marches descendent sur 13 niveaux en parfaite symétrie géométrique (entrée étrangers environ ₹300 ; ouvert tous les jours de 8h à 18h). Arrivée à Jaipur en début de soirée et installation dans votre hôtel-haveli historique, la soirée étant libre pour explorer les étals de bijoux et de textiles du Johari Bazaar.",
      ...
      },
      {
        ...
        title: "Départ",
        description:
          "Une dernière matinée tranquille avant votre transfert vers l'aéroport international de Delhi. Notre équipe confirme au préalable les détails de votre vol de retour et reste joignable jusqu'à votre enregistrement. Vous partez en gardant en mémoire le Taj au lever du soleil, les tigres de Ranthambore, un puits à degrés comme aucun autre chez vous, des chameaux sur un lac du désert et, si vous avez ajouté l'extension, la plus ancienne ville du monde, dont le feu éternel brûle toujours sur les rives du fleuve.",
        overnight: "—",
        highlight: "Un dernier café avant l'aéroport — douze jours condensés en tout ce que vous vouliez voir",
      },
    ],
    inclusions: [
      "11 nuits d'hébergement : 2× hôtel-boutique à Delhi + 1× hôtel-boutique à Agra + 2× jungle-lodge à Ranthambore + 2× hôtel-haveli historique à Jaipur + 1× maison d'hôtes historique à Pushkar + 2× hôtel historique à Varanasi + 1× hôtel proche de l'aéroport de Delhi (chambre double)",
      "Véhicule privé climatisé pour toutes les visites et tous les transferts routiers (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 safaris en jeep (gypsy) partagés dans le Parc national de Ranthambore avec guide naturaliste, entrée au parc national et frais de safari inclus",
      "Halte à Chand Baori (puits à degrés d'Abhaneri) sur la route Ranthambore–Jaipur",
    ...
    exclusions: [
      ...
      "Option de safari en jeep privé (non partagé) à Ranthambore (optionnel, environ ₹3 000–5 000 supplémentaires par véhicule et par safari)",
      ...
      "Option éléphant/jeep au Fort d'Amber ou balades à dos de chameau au-delà de celles mentionnées",
      "Assurance voyage et santé (fortement recommandée)",
      "TPS de 5 % sur le montant total du forfait",
    ],
    pricing: [
      { label: "Chambre double — Standard, avec Varanasi (depuis Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Chambre double — Premium, avec Varanasi (depuis Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Chambre double — Standard, sans Varanasi, 9 jours (depuis Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17 – 27 octobre 2026 (départ de groupe fixe)",
      "14 – 24 novembre 2026 (départ de groupe fixe — Spécial Foire aux chameaux de Pushkar)",
      "28 novembre – 8 décembre 2026 (départ de groupe fixe)",
      "19 – 29 décembre 2026 (départ de groupe fixe)",
      "16 – 26 janvier 2027 (départ de groupe fixe)",
      "13 – 23 février 2027 (départ de groupe fixe)",
      "13 – 23 mars 2027 (départ de groupe fixe)",
...
const journeysEsOverrides: JourneyOverrideMap = {
  "northeast-india-meghalaya": {
    ...
    exclusions: [
      "Vuelos de ida y vuelta Delhi ↔ Guwahati (aprox. 70–115 $ por tramo; le ayudamos con la reserva si lo solicita)",
    ...
    pricing: [
      { label: "Habitación doble (desde Guwahati)", priceUSD: 2099, priceINR: 206700 },
      { label: "Habitación doble (desde Delhi)", priceUSD: 2399, priceINR: 228500 },
    ],
  ...
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Habitación doble — Estándar (desde Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Habitación doble — Premium (desde Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
    departures: ["Personalizable — contáctanos"],
  },
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      ...
      "Almuerzos durante el viaje (recomendamos restaurantes locales de confianza — presupuesta unos 9–14 $ por comida)",
    ...
    pricing: [
      { label: "Habitación doble — Premium (desde Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Habitación doble — Estándar (desde Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    departures: ["Personalizable — contáctanos"],
  },
  "paradise-of-kashmir": {
  ...
  "golden-triangle-pushkar-varanasi": {
    title: "Triángulo Dorado, Ranthambore, Pushkar y Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — el circuito clásico más una reserva de tigres, un lago del desierto y la ciudad más antigua del mundo",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar y Varanasi, Norte de la India",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (opcional) → Delhi",
    groupSize: "Máx. 10 viajeros",
    difficulty: "Easy",
    summary:
      "El Taj Mahal al amanecer, dos safaris en jeep en busca de tigres por los bosques y la fortaleza en ruinas de Ranthambore, una fortaleza rajput que se alza sobre un lago, un pozo escalonado de 1.200 años excavado en la tierra, camellos cruzando dunas junto a un lago sagrado del desierto y, para quienes la añaden, la ciudad habitada sin interrupción más antigua del mundo. Doce días diseñados específicamente para quienes visitan la India por primera vez, con cada trayecto, cada tarifa de monumento, cada safari y cada horario de apertura verificados de antemano.",
    overview:
      "Este es el itinerario que diseñamos con más frecuencia para viajeros de Europa y Norteamérica que visitan la India por primera vez, porque responde a la pregunta '¿qué debería ver realmente en doce días?' sin apresurar ni saturar el viaje. Comienza con el Triángulo Dorado — Delhi, Agra, Jaipur — la introducción esencial a la India, con un desvío al sur de Agra hasta Ranthambore, una de las mejores reservas de tigres de la India, para dos safaris en jeep antes de continuar hacia Jaipur. Desde allí giramos hacia el suroeste hasta Pushkar, una pequeña ciudad sagrada junto a un lago sagrado a la que la mayoría de los viajeros primerizos nunca llega y que casi siempre califican como lo mejor del viaje. Desde Pushkar volvemos a Delhi y, para quienes lo deseen, volamos hasta Varanasi — la ciudad viva más antigua del mundo, donde el Ganges corre entre el mundo de los vivos y el más allá. Nos movemos íntegramente en vehículo privado con aire acondicionado entre Delhi, Agra, Ranthambore, Jaipur y Pushkar (con tiempos de viaje realistas incorporados en cada jornada, no las cifras 'optimistas' que ofrecen algunos operadores), y en un vuelo doméstico corto entre Delhi y Varanasi en lugar de un tren de más de 8 horas, porque en un viaje de doce días su tiempo es el recurso más escaso. Cada visita a un monumento y cada safari de este itinerario están programados según los horarios reales de apertura, los turnos de safari y la tarifa de entrada actual para extranjeros — el amanecer en el Taj antes de que se formen las colas, turnos de safari de mañana y tarde en Ranthambore, el Fuerte Amber antes del calor del mediodía, la Ganga Aarti a la hora en que realmente se celebra. Shikha o un anfitrión de GoTrustelle está disponible durante todo el viaje, y todo el recorrido está pensado en torno a las preguntas que más hacen los viajeros europeos y estadounidenses: ¿es seguro?, ¿qué voy a comer?, ¿qué debo ponerme? y ¿cómo llego de un punto a otro sin perder un día en el tráfico. Realizamos este itinerario de octubre a marzo, cuando las temperaturas diurnas son agradables tanto para las visitas como para los safaris, y el bosque seco y despejado de Ranthambore hace que los avistamientos de tigres sean mucho más probables que en los meses de más calor.",
    highlights: [
      "El Taj Mahal al amanecer — 30 minutos con el mármol solo para ustedes, antes de que lleguen las multitudes",
      "El Parque Nacional de Ranthambore — dos safaris en jeep en una de las principales reservas de tigres de la India, en busca de tigres, leopardos y osos perezosos entre las ruinas de una fortaleza del siglo X",
      ...
      "La Feria del Camello de Pushkar (solo en la salida del 14 al 24 de noviembre) — el mayor festival popular de Rajasthan, miles de camellos, comerciantes y artistas a la orilla del lago",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "El Taj Mahal al amanecer — Agra → Ranthambore",
        description:
          "Salida temprana: el Taj Mahal abre 30 minutos antes del amanecer (las taquillas abren una hora antes), y esta primera media hora — luz suave, pocas multitudes — es la razón por la que organizamos todo el viaje alrededor de ella (entrada extranjeros ₹1.100, más ₹200 por el interior del mausoleo; menores de 15 años gratis; cerrado todos los viernes, en cuyo caso esta visita se traslada a la tarde del día 3). Tras el desayuno, salida hacia Ranthambore (aprox. 280 km, 5–5,5 horas, con parada para el almuerzo en el camino), registro en su lodge de selva junto al parque nacional a última hora de la tarde. Si el horario lo permite, salida para un primer safari al atardecer: un jeep abierto de 6 plazas con guía naturalista entra en el parque para el turno de la tarde (entrada al parque nacional y tasas de safari incluidas; la zona la asigna el departamento forestal) — tigres, ciervos moteados y las ruinas del Fuerte de Ranthambore dentro del parque.",
        overnight: "Lodge de selva, Ranthambore",
        highlight: "Amanecer en el Taj, safari al atardecer en territorio de tigres — dos caras muy distintas de la India en un solo día",
      },
      {
        day: 5,
        title: "Parque Nacional de Ranthambore — safaris en jeep al amanecer y por la tarde",
        description:
          "Un día completo construido en torno a los dos turnos de safari del parque, cada uno en un jeep abierto de 6 plazas con guía naturalista (la zona la asigna el departamento forestal cada día). El safari del amanecer sorprende al parque despertando — langures, sambares y ciervos moteados junto a los lagos, y las mejores probabilidades de avistar un tigre del día, mientras se desplazan antes de que llegue el calor. Entre los dos safaris, descanso en el lodge o, si el horario lo permite, visita al Fuerte de Ranthambore, una fortaleza en la colina del siglo X dentro de la reserva, desde cuyas murallas a veces se avistan tigres. El safari de la tarde explora una zona diferente — osos perezosos, cocodrilos de pantano y, con suerte, un tigre. Los avistamientos son frecuentes aquí, pero como en cualquier encuentro con vida silvestre, nunca están garantizados.",
        overnight: "Lodge de selva, Ranthambore",
        highlight: "Dos safaris en jeep en una de las mejores reservas de tigres de la India — turnos de amanecer y de tarde",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur vía el pozo escalonado de Abhaneri",
        description:
          "Una salida relajada a última hora de la mañana desde Ranthambore hacia Jaipur (aprox. 220 km vía Abhaneri, 4,5–5 horas), con una parada en Abhaneri para ver Chand Baori — el pozo escalonado de 1.200 años que los lugareños llaman 'baori ki haveli', cuyos 3.500 escalones descienden 13 pisos en perfecta simetría geométrica (entrada extranjeros aprox. ₹300; abierto todos los días de 8 a 18 h). Llegada a Jaipur a primera hora de la tarde y registro en su hotel-haveli patrimonial, con la tarde libre para explorar los puestos de joyería y textiles del Johari Bazaar.",
      ...
      },
      {
        ...
        title: "Salida",
        description:
          "Una última mañana tranquila antes de su traslado al aeropuerto internacional de Delhi. Nuestro equipo confirma de antemano los detalles de su vuelo de regreso y permanece disponible hasta que haya hecho el check-in. Se marchan con el Taj al amanecer, los tigres de Ranthambore, un pozo escalonado como ningún otro en casa, camellos en un lago del desierto y, si añadieron la extensión, la ciudad más antigua del mundo, cuyo fuego eterno todavía arde en la orilla del río.",
        overnight: "—",
        highlight: "Un último café antes del aeropuerto — doce días condensados en todo lo que querían ver",
      },
    ],
    inclusions: [
      "11 noches de alojamiento: 2× hotel boutique en Delhi + 1× hotel boutique en Agra + 2× lodge de selva en Ranthambore + 2× hotel-haveli patrimonial en Jaipur + 1× casa de huéspedes patrimonial en Pushkar + 2× hotel patrimonial en Varanasi + 1× hotel cercano al aeropuerto de Delhi (habitación doble)",
      "Vehículo privado con aire acondicionado para todas las visitas y traslados por carretera (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 safaris en jeep (gypsy) compartido en el Parque Nacional de Ranthambore con guía naturalista, incluyendo entrada al parque nacional y tasas de safari",
      "Parada en Chand Baori (pozo escalonado de Abhaneri) en el trayecto Ranthambore–Jaipur",
    ...
    exclusions: [
      ...
      "Mejora a safari en jeep privado (no compartido) en Ranthambore (opcional, aprox. ₹3.000–5.000 adicionales por vehículo y safari)",
      "Darshan Sugam/VIP en Kashi Vishwanath (opcional, aprox. ₹250)",
      "Almuerzos durante el recorrido (presupuesto ₹500–800 por comida)",
      "Gastos personales: compras, propinas, bebidas",
      "Opción de elefante/jeep en el Fuerte Amber o paseos en camello adicionales a los incluidos",
      "Seguro de viaje y médico (muy recomendado)",
      "5% de GST sobre el valor total del paquete",
    ],
    pricing: [
      { label: "Habitación doble — Estándar, con Varanasi (desde Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Habitación doble — Premium, con Varanasi (desde Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Habitación doble — Estándar, sin Varanasi, 9 días (desde Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17 – 27 de octubre de 2026 (salida de grupo fija)",
      "14 – 24 de noviembre de 2026 (salida de grupo fija — Especial Feria del Camello de Pushkar)",
      "28 de noviembre – 8 de diciembre de 2026 (salida de grupo fija)",
      "19 – 29 de diciembre de 2026 (salida de grupo fija)",
      "16 – 26 de enero de 2027 (salida de grupo fija)",
      "13 – 23 de febrero de 2027 (salida de grupo fija)",
      "13 – 23 de marzo de 2027 (salida de grupo fija)",
...
const journeysItOverrides: JourneyOverrideMap = {
  "northeast-india-meghalaya": {
    ...
    exclusions: [
      "Volo di andata e ritorno Delhi ↔ Guwahati (circa 70–115 $ a tratta; su richiesta vi assistiamo nella prenotazione)",
    ...
    pricing: [
      { label: "Camera doppia (da Guwahati)", priceUSD: 2099, priceINR: 206700 },
      { label: "Camera doppia (da Delhi)", priceUSD: 2399, priceINR: 228500 },
    ],
  ...
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Camera doppia — Standard (da Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Camera doppia — Premium (da Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
    departures: ["Personalizzabile — contattaci"],
  },
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      ...
      "Pranzi durante il tour (consigliamo ristoranti locali di fiducia — budget di circa $9–14 a pasto)",
    ...
    pricing: [
      { label: "Camera doppia — Premium (da Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Camera doppia — Standard (da Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    departures: ["Personalizzabile — contattaci"],
  },
  "paradise-of-kashmir": {
    ...
    pricing: [
      { label: "Deluxe (6 persone)", priceUSD: 1899, priceINR: 185000 },
      { label: "Premium (6 persone)", priceUSD: 1999, priceINR: 195900 },
      { label: "Royal (6 persone)", priceUSD: 2099, priceINR: 206700 },
    ],
    departures: ["Personalizzabile — contattaci"],
  },
  "golden-triangle-pushkar-varanasi": {
    title: "Triangolo d'Oro, Ranthambore, Pushkar e Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — il circuito classico con l'aggiunta di una riserva di tigri, un lago nel deserto e la città più antica del mondo",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar e Varanasi, India del Nord",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (opzionale) → Delhi",
    groupSize: "Max 10 viaggiatori",
    difficulty: "Easy",
    summary:
      "Il Taj Mahal all'alba, due safari in jeep sulle tracce delle tigri tra le foreste e la fortezza in rovina di Ranthambore, una fortezza rajput che si affaccia su un lago, un pozzo a gradoni di 1.200 anni scavato nella terra, cammelli che attraversano le dune di un lago sacro nel deserto e, per chi la aggiunge, la città abitata ininterrottamente più antica del mondo. Dodici giorni pensati appositamente per chi visita l'India per la prima volta, con ogni tratta di viaggio, ogni tariffa dei monumenti, ogni safari e ogni orario di apertura verificati in anticipo.",
    overview:
      "Questo è l'itinerario che costruiamo più spesso per i viaggiatori europei e nordamericani alla prima visita in India, perché risponde alla domanda 'cosa dovrei davvero vedere in dodici giorni?' senza affollare né correre. Inizia con il Triangolo d'Oro — Delhi, Agra, Jaipur — l'introduzione essenziale all'India, con una deviazione a sud di Agra verso Ranthambore, una delle migliori riserve di tigri dell'India, per due safari in jeep prima di proseguire verso Jaipur. Da lì si vira a sud-ovest verso Pushkar, una piccola città sacra su un lago sacro che la maggior parte dei viaggiatori alla prima esperienza non raggiunge mai e che quasi sempre definiscono il punto più alto del viaggio. Da Pushkar torniamo a Delhi e, per chi lo desidera, si vola verso Varanasi — la città vivente più antica del mondo, dove il Ganges scorre tra il mondo dei vivi e quello dell'aldilà. Ci spostiamo interamente con un veicolo privato con aria condizionata tra Delhi, Agra, Ranthambore, Jaipur e Pushkar (con tempi di viaggio realistici inseriti in ogni giornata, non le cifre 'ottimistiche' di alcuni operatori), e con un breve volo interno tra Delhi e Varanasi invece di un treno di oltre 8 ore, perché in un viaggio di dodici giorni il tempo è la risorsa più scarsa. Ogni visita ai monumenti e ogni safari in questo itinerario sono programmati in base agli orari di apertura reali, ai turni di safari e alla tariffa d'ingresso attuale per i cittadini stranieri — l'alba al Taj prima che si formino le code, turni di safari al mattino e al pomeriggio a Ranthambore, il Forte di Amber prima del caldo del mezzogiorno, la Ganga Aarti all'ora in cui viene realmente celebrata. Shikha o un ospite GoTrustelle è raggiungibile durante tutto il viaggio, e l'intero percorso è pensato attorno alle domande che i viaggiatori europei e americani si pongono più spesso: è sicuro, cosa mangio, cosa indosso e come si va da un punto all'altro senza perdere una giornata nel traffico. Organizziamo questo itinerario da ottobre a marzo, quando le temperature diurne sono piacevoli sia per le visite sia per i safari, e la foresta secca e più rada di Ranthambore rende gli avvistamenti delle tigri molto più probabili rispetto ai mesi più caldi.",
    highlights: [
      "Il Taj Mahal all'alba — 30 minuti con il marmo tutto per voi, prima dell'arrivo della folla",
      "Il Parco Nazionale di Ranthambore — due safari in jeep in una delle principali riserve di tigri dell'India, sulle tracce di tigri, leopardi e orsi labiati tra le rovine di una fortezza del X secolo",
      ...
      "La Fiera dei Cammelli di Pushkar (solo partenza 14–24 novembre) — il più grande festival popolare del Rajasthan, migliaia di cammelli, mercanti e artisti sulle rive del lago",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "Il Taj Mahal all'alba — Agra → Ranthambore",
        description:
          "Partenza anticipata: il Taj Mahal apre 30 minuti prima dell'alba (le biglietterie aprono un'ora prima), e questa prima mezz'ora — luce soffusa, poche persone — è il motivo per cui costruiamo l'intero viaggio attorno ad essa (ingresso stranieri ₹1.100, più ₹200 per l'interno del mausoleo; gratis per i minori di 15 anni; chiuso ogni venerdì, nel qual caso questa visita si sposta al pomeriggio del giorno 3). Dopo la colazione, partenza per Ranthambore (circa 280 km, 5–5,5 ore, con sosta pranzo lungo il percorso), check-in nel vostro jungle lodge ai margini del parco nazionale nel tardo pomeriggio. Se gli orari lo consentono, si parte per un primo safari serale: una jeep aperta da 6 posti con guida naturalistica entra nel parco per il turno serale (ingresso al parco nazionale e tariffe del safari incluse; la zona viene assegnata dall'ente forestale) — tigri, cervi pomellati e le rovine della Fortezza di Ranthambore all'interno del parco.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Alba al Taj, safari serale nel territorio delle tigri — due volti molto diversi dell'India in un solo giorno",
      },
      {
        day: 5,
        title: "Parco Nazionale di Ranthambore — safari in jeep all'alba e al pomeriggio",
        description:
          "Una giornata intera costruita attorno ai due turni di safari del parco, ciascuno su una jeep aperta da 6 posti con guida naturalistica (la zona viene assegnata ogni giorno dall'ente forestale). Il safari dell'alba coglie il parco al risveglio — langur, cervi sambar e cervi pomellati presso i laghi, e le migliori possibilità della giornata di avvistare una tigre, mentre si spostano prima che arrivi il caldo. Tra un safari e l'altro, riposo al lodge o, se gli orari lo consentono, visita alla Fortezza di Ranthambore, una fortezza collinare del X secolo all'interno della riserva, dalle cui mura talvolta si avvistano le tigri. Il safari pomeridiano esplora una zona diversa — orsi labiati, coccodrilli palustri e, con un po' di fortuna, una tigre. Gli avvistamenti qui sono frequenti ma, come in ogni incontro con la fauna selvatica, mai garantiti.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Due safari in jeep in una delle migliori riserve di tigri dell'India — turni all'alba e al pomeriggio",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur via il pozzo a gradoni di Abhaneri",
        description:
          "Una partenza rilassata a fine mattinata da Ranthambore verso Jaipur (circa 220 km via Abhaneri, 4,5–5 ore), con una sosta ad Abhaneri per vedere Chand Baori — il pozzo a gradoni di 1.200 anni che gli abitanti chiamano 'baori ki haveli', i cui 3.500 gradini scendono per 13 piani in perfetta simmetria geometrica (ingresso stranieri circa ₹300; aperto tutti i giorni dalle 8 alle 18). Arrivo a Jaipur in prima serata e check-in nel vostro hotel-haveli storico, con la serata libera per esplorare le bancarelle di gioielli e tessuti del Johari Bazaar.",
      ...
      },
      {
        ...
        title: "Partenza",
        description:
          "Un'ultima mattinata rilassata prima del trasferimento all'aeroporto internazionale di Delhi. Il nostro team confermerà in anticipo i dettagli del vostro volo di ritorno e resterà raggiungibile finché non avrete effettuato il check-in. Partite portando con voi il Taj all'alba, le tigri di Ranthambore, un pozzo a gradoni diverso da tutto ciò che conoscete a casa, cammelli su un lago nel deserto e, se avete aggiunto l'estensione, la città più antica del mondo, dove il fuoco eterno arde ancora sulle rive del fiume.",
        overnight: "—",
        highlight: "Un ultimo caffè prima dell'aeroporto — dodici giorni condensati in tutto ciò che volevate vedere",
      },
    ],
    inclusions: [
      "11 notti di alloggio: 2× hotel boutique a Delhi + 1× hotel boutique ad Agra + 2× jungle lodge a Ranthambore + 2× hotel-haveli storico a Jaipur + 1× guesthouse storica a Pushkar + 2× hotel storico a Varanasi + 1× hotel vicino all'aeroporto di Delhi (camera doppia)",
      "Veicolo privato con aria condizionata per tutte le visite e i trasferimenti su strada (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 safari in jeep (gypsy) condivisi nel Parco Nazionale di Ranthambore con guida naturalistica, ingresso al parco nazionale e tariffe del safari incluse",
      "Sosta a Chand Baori (pozzo a gradoni di Abhaneri) nel tragitto Ranthambore–Jaipur",
    ...
    exclusions: [
      ...
      "Upgrade a safari in jeep privato (non condiviso) a Ranthambore (opzionale, circa ₹3.000–5.000 in più per veicolo e per safari)",
      ...
      "Opzione elefante/jeep al Forte di Amber o giri in cammello aggiuntivi rispetto a quelli elencati",
      "Assicurazione viaggio e sanitaria (fortemente consigliata)",
      "GST del 5% sul valore totale del pacchetto",
    ],
    pricing: [
      { label: "Camera doppia — Standard, con Varanasi (da Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Camera doppia — Premium, con Varanasi (da Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Camera doppia — Standard, senza Varanasi, 9 giorni (da Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17 – 27 ottobre 2026 (partenza di gruppo fissa)",
      "14 – 24 novembre 2026 (partenza di gruppo fissa — Speciale Fiera dei Cammelli di Pushkar)",
      "28 novembre – 8 dicembre 2026 (partenza di gruppo fissa)",
      "19 – 29 dicembre 2026 (partenza di gruppo fissa)",
      "16 – 26 gennaio 2027 (partenza di gruppo fissa)",
      "13 – 23 febbraio 2027 (partenza di gruppo fissa)",
      "13 – 23 marzo 2027 (partenza di gruppo fissa)",
...
const journeysPtOverrides: JourneyOverrideMap = {
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Quarto duplo — Standard (a partir de Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Quarto duplo — Premium (a partir de Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
  ...
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      ...
      "Almoços durante o tour (recomendamos restaurantes locais de confiança — orçar cerca de $9–14 por refeição)",
    ...
    pricing: [
      { label: "Quarto duplo — Premium (a partir de Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Quarto duplo — Padrão (a partir de Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    departures: ["Personalizável — contate-nos"],
  },
  "paradise-of-kashmir": {
    ...
    pricing: [
      { label: "Deluxe (6 pessoas)", priceUSD: 1899, priceINR: 185000 },
      { label: "Premium (6 pessoas)", priceUSD: 1999, priceINR: 195900 },
      { label: "Royal (6 pessoas)", priceUSD: 2099, priceINR: 206700 },
    ],
    departures: ["Personalizável — contate-nos"],
  },
  "golden-triangle-pushkar-varanasi": {
    title: "Triângulo Dourado, Ranthambore, Pushkar e Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — o circuito clássico com uma reserva de tigres, um lago no deserto e a cidade mais antiga do mundo",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar e Varanasi, Norte da Índia",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (opcional) → Delhi",
    groupSize: "Máx. 10 viajantes",
    difficulty: "Easy",
    summary:
      "O Taj Mahal ao nascer do sol, dois safáris de jipe completos rastreando tigres pelas florestas e pelo forte em ruínas de Ranthambore, uma fortaleza rajput erguida sobre um lago, um poço em degraus de 1.200 anos escavado na terra, camelos atravessando dunas junto a um lago sagrado no deserto e, para quem a adicionar, a cidade continuamente habitada mais antiga do mundo. Doze dias criados especificamente para quem visita a Índia por primeira vez, com cada trajeto, cada tarifa de monumento, cada safári e cada horário de funcionamento verificados com antecedência.",
    overview:
      "Este é o roteiro que mais construímos para viajantes da Europa e América do Norte em sua primeira visita à Índia, porque responde à pergunta 'o que devo realmente ver em doze dias?' sem apressar nem sobrecarregar. Começa com o Triângulo Dourado — Delhi, Agra, Jaipur — a introdução essencial à Índia, com um desvio ao sul de Agra até Ranthambore, uma das melhores reservas de tigres da Índia, para um dia inteiro com dois safáris de jipe antes de seguir para Jaipur. De lá seguimos rumo a sudoeste até Pushkar, uma pequena cidade sagrada junto a um lago sagrado que a maioria dos viajantes de primeira viagem nunca alcança e que quase sempre classificam como o ponto alto da viagem. De Pushkar retornamos a Delhi e, para quem desejar, voamos até Varanasi — a mais antiga cidade viva do mundo, onde o Ganges corre entre o mundo dos vivos e o além. Deslocamo-nos inteiramente em veículo privado com ar-condicionado entre Delhi, Agra, Ranthambore, Jaipur e Pushkar (com tempos de viagem realistas incorporados a cada dia, não os números 'otimistas' de alguns operadores), e por um curto voo doméstico entre Delhi e Varanasi em vez de um trem de mais de 8 horas, porque em uma viagem de doze dias o seu tempo é o recurso mais escasso. Cada visita a monumentos e cada safári deste roteiro são programados de acordo com os horários reais de funcionamento, os turnos de safári e a tarifa de entrada atual para estrangeiros — o nascer do sol no Taj antes de as filas se formarem, os turnos de safári da manhã e da tarde em Ranthambore, o Forte Amber antes do calor do meio-dia, a Ganga Aarti na hora em que é realmente celebrada. Shikha ou um anfitrião da GoTrustelle está disponível durante toda a viagem, e todo o roteiro é pensado em torno das perguntas que viajantes europeus e americanos mais fazem: é seguro, o que vou comer, o que devo vestir e como ir de um ponto a outro sem perder um dia no trânsito. Organizamos este roteiro de outubro a março, quando as temperaturas diurnas são agradáveis tanto para as visitas quanto para os safáris, e a floresta seca e mais rala de Ranthambore torna os avistamentos de tigres muito mais prováveis do que nos meses mais quentes.",
    highlights: [
      "O Taj Mahal ao nascer do sol — 30 minutos com o mármore só para vocês, antes da chegada das multidões",
      "Parque Nacional de Ranthambore — dois safáris de jipe em uma das melhores reservas de tigres da Índia, rastreando tigres, leopardos e ursos-beiçudos entre as ruínas de um forte do século X",
      ...
      "A Feira do Camelo de Pushkar (apenas na partida de 14 a 24 de novembro) — o maior festival popular do Rajasthan, milhares de camelos, comerciantes e artistas às margens do lago",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "O Taj Mahal ao nascer do sol — Agra → Ranthambore",
        description:
          "Início antecipado: o Taj Mahal abre 30 minutos antes do nascer do sol (as bilheterias abrem uma hora antes), e essa primeira meia hora — luz suave, poucas multidões — é o motivo pelo qual construímos toda a viagem em torno dela (entrada estrangeiros ₹1.100, mais ₹200 pelo interior do mausoléu; menores de 15 anos entram gratuitamente; fechado todas as sextas-feiras, caso em que esta visita passa para a tarde do dia 3). Após o café da manhã, partida para Ranthambore (aprox. 280 km, 5h–5h30, com uma parada para o almoço no caminho), com check-in na sua pousada na jungle nos limites do parque nacional no final da tarde. Se os horários permitirem, seguimos direto para um safári noturno de jipe — um jipe aberto de 6 lugares (gypsy) com um guia naturalista entra no parque para o turno da noite (entrada no parque nacional e taxas de safári incluídas; zona definida pelo departamento florestal) — tigres, cervos-pintados e as muralhas em ruínas do Forte de Ranthambore dentro do parque, na mesma luz dourada que fez o Taj brilhar naquela manhã.",
        overnight: "Pousada na jungle, Ranthambore",
        highlight: "O nascer do sol no Taj e um safári noturno de jipe em território de tigres — duas Índias muito diferentes em um só dia",
      },
      {
        day: 5,
        title: "Parque Nacional de Ranthambore — safáris de jipe ao amanhecer e à tarde",
        description:
          "Um dia inteiro dedicado aos dois turnos de safári de Ranthambore, cada um em um jipe aberto de 6 lugares (gypsy) com um guia naturalista (zona definida pelo departamento florestal a cada dia; entrada no parque nacional e taxas de safári incluídas). O safári do amanhecer capta o parque despertando — os langures chamando, sambares e cervos-pintados junto aos lagos, e a melhor chance do dia de avistar um tigre, já que eles se movem antes do calor chegar. Entre os safáris, descanse na pousada ou, se o horário permitir, dê uma olhada no Forte de Ranthambore, um forte na colina do século X que ainda se ergue dentro da reserva, onde tigres residentes às vezes são vistos das suas muralhas. O safári da tarde segue para uma zona diferente, com boas chances de avistar ursos-beiçudos, crocodilos-de-pântano e, com alguma sorte, um dos tigres residentes do parque. Avistamentos de tigres são comuns aqui, mas nunca garantidos — nós lhes damos um panorama honesto das chances antes de reservarem.",
        overnight: "Pousada na jungle, Ranthambore",
        highlight: "Dois safáris de jipe em uma das melhores reservas de tigres da Índia — turnos do amanhecer e da tarde",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur via o poço em degraus de Abhaneri",
        description:
          "Uma partida tranquila no final da manhã, saindo de Ranthambore rumo a Jaipur (aprox. 220 km via Abhaneri, 4h30–5h), com uma parada em Abhaneri para ver Chand Baori — o poço em degraus de 1.200 anos que os moradores chamam de 'baori ki haveli', cujos 3.500 degraus descem 13 andares em perfeita simetria geométrica (entrada estrangeiros aprox. ₹300; aberto todos os dias das 8h às 18h). Chegada a Jaipur no início da noite e check-in no seu hotel-haveli histórico, com a noite livre para explorar as bancas de joias e tecidos do Johari Bazaar.",
      ...
      },
      {
        ...
        title: "Partida",
        description:
          "Uma última manhã tranquila antes da sua transferência para o aeroporto internacional de Delhi. A nossa equipe confirma com antecedência os detalhes do seu voo de retorno e permanece disponível até você fazer o check-in. Vocês partem levando o Taj ao amanhecer, tigres em Ranthambore, um poço em degraus diferente de tudo que já viram em casa, camelos em um lago no deserto e, se adicionaram a extensão, a cidade mais antiga do mundo, cujo fogo eterno ainda arde às margens do rio.",
        overnight: "—",
        highlight: "Um último café antes do aeroporto — doze dias condensados em tudo o que vocês queriam ver",
      },
    ],
    inclusions: [
      "11 noites de acomodação: 2× hotel boutique em Delhi + 1× hotel boutique em Agra + 2× pousada na jungle em Ranthambore + 2× hotel-haveli histórico em Jaipur + 1× pousada histórica em Pushkar + 2× hotel histórico em Varanasi + 1× hotel próximo ao aeroporto de Delhi (quarto duplo)",
      "Veículo privado com ar-condicionado para todos os passeios e transferências por estrada (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 safáris de jipe (gypsy) compartilhados no Parque Nacional de Ranthambore com guia naturalista, incluindo entrada no parque nacional e taxas de safári",
      "Parada em Chand Baori (poço em degraus de Abhaneri) no trajeto Ranthambore–Jaipur",
    ...
    exclusions: [
      ...
      "Upgrade para safári de jipe privado (não compartilhado) em Ranthambore (opcional, aprox. ₹3.000–5.000 extra por veículo por safári)",
      "Darshan Sugam/VIP em Kashi Vishwanath (opcional, aprox. ₹250)",
      "Almoços durante o passeio (orçamento ₹500–800 por refeição)",
      "Despesas pessoais: compras, gorjetas, bebidas",
      "Opção de elefante/jipe no Forte Amber ou passeios de camelo além dos listados",
      "Seguro de viagem e saúde (altamente recomendado)",
      "5% de GST sobre o valor total do pacote",
    ],
    pricing: [
      { label: "Quarto duplo — Standard, com Varanasi (a partir de Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Quarto duplo — Premium, com Varanasi (a partir de Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Quarto duplo — Standard, sem Varanasi, 9 dias (a partir de Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17 – 27 de outubro de 2026 (partida de grupo fixa)",
      "14 – 24 de novembro de 2026 (partida de grupo fixa — Especial Feira do Camelo de Pushkar)",
      "28 de novembro – 8 de dezembro de 2026 (partida de grupo fixa)",
      "19 – 29 de dezembro de 2026 (partida de grupo fixa)",
      "16 – 26 de janeiro de 2027 (partida de grupo fixa)",
      "13 – 23 de fevereiro de 2027 (partida de grupo fixa)",
      "13 – 23 de março de 2027 (partida de grupo fixa)",
...
const journeysNlOverrides: JourneyOverrideMap = {
  "kerala-backwaters-escape": {
    ...
    pricing: [
      { label: "Tweepersoonskamer — Standaard (vanaf Kochi)", priceUSD: 1899, priceINR: 185000 },
      { label: "Tweepersoonskamer — Premium (vanaf Kochi)", priceUSD: 2399, priceINR: 228500 },
    ],
  ...
  "rishikesh-himalayan-escape": {
    ...
    exclusions: [
      ...
      "Lunches tijdens de reis (we adviseren vertrouwde lokale restaurants — reken op ongeveer $9–14 per maaltijd)",
    ...
    pricing: [
      { label: "Tweepersoonskamer — Premium (vanaf Delhi)", priceUSD: 1499, priceINR: 141400 },
      { label: "Tweepersoonskamer — Standaard (vanaf Delhi)", priceUSD: 1699, priceINR: 163200 },
    ],
    departures: ["Op maat — neem contact op"],
  },
  "paradise-of-kashmir": {
  ...
  "golden-triangle-pushkar-varanasi": {
    title: "Golden Triangle, Ranthambore, Pushkar & Varanasi",
    subtitle: "Delhi · Agra · Ranthambore · Jaipur · Pushkar · Varanasi — de klassieke route aangevuld met een tijgerreservaat, een woestijnmeer en de oudste stad op aarde",
    region: "Delhi, Agra, Ranthambore, Jaipur, Pushkar & Varanasi, Noord-India",
    route: "Delhi → Agra → Ranthambore → Jaipur → Pushkar → Delhi → Varanasi (optioneel) → Delhi",
    groupSize: "Max. 10 reizigers",
    difficulty: "Easy",
    summary:
      "De Taj Mahal bij zonsopgang, twee volledige jeepsafari's op zoek naar tijgers door de bossen en het vervallen fort van Ranthambore, een Rajput-fort dat boven een meer uittorent, een 1.200 jaar oude trapput die diep in de aarde is uitgehouwen, kamelen die duinen oversteken bij een heilig woestijnmeer en — voor wie dat toevoegt — de oudste ononderbroken bewoonde stad op aarde. Twaalf dagen speciaal opgezet voor mensen die India voor het eerst bezoeken, waarbij elke reisafstand, elk toegangsbewijs, elke safari en elke openingstijd vooraf gecontroleerd is.",
    overview:
      "Dit is het reisschema dat we het vaakst samenstellen voor reizigers uit Europa en Noord-Amerika die voor het eerst naar India gaan, omdat het antwoord geeft op de vraag 'wat moet ik in twaalf dagen nu echt zien?' zonder te haasten of te overladen. Het begint met de Golden Triangle — Delhi, Agra, Jaipur — de essentiële introductie tot India, met een omweg ten zuiden van Agra naar Ranthambore, een van de beste tijgerreservaten van India, voor een volledige dag met twee jeepsafari's voordat we verder reizen naar Jaipur. Vanaf daar buigen we naar het zuidwesten richting Pushkar, een klein heilig stadje aan een heilig meer dat de meeste eerste-keer-reizigers nooit bereiken en dat ze bijna altijd het hoogtepunt van de reis noemen. Vanuit Pushkar keren we terug naar Delhi en, voor gasten die dat willen, vliegen we door naar Varanasi — de oudste nog levende stad op aarde, waar de Ganges stroomt tussen de wereld van de levenden en die daarna. We reizen volledig per privé airconditioned voertuig tussen Delhi, Agra, Ranthambore, Jaipur en Pushkar (met realistische reistijden ingepland voor elke dag, niet de 'optimistische' cijfers die sommige reisorganisaties gebruiken), en met een korte binnenlandse vlucht tussen Delhi en Varanasi in plaats van een trein van meer dan 8 uur, omdat op een reis van twaalf dagen uw tijd de schaarste hulpbron is. Elk monumentbezoek en elke safari in dit reisschema is afgestemd op de werkelijke openingstijden, de safariploegen en de huidige toegangsprijs voor buitenlandse bezoekers — zonsopgang bij de Taj voordat de rijen ontstaan, de safariploegen bij zonsopgang en in de middag in Ranthambore, Amber Fort voor de middaghitte, de Ganga Aarti op het uur waarop deze werkelijk wordt uitgevoerd. Shikha of een GoTrustelle-gastheer is de hele reis bereikbaar, en de gehele reis is opgezet rond de vragen die Europese en Amerikaanse reizigers het vaakst stellen: is het veilig, wat eet ik, wat draag ik, en hoe kom ik van A naar B zonder een dag in het verkeer te verliezen. We plannen dit reisschema van oktober tot maart, wanneer de temperatuur overdag comfortabel is voor zowel bezichtigingen als safari's en het droge, uitgedunde bos van Ranthambore tijgerwaarnemingen aanzienlijk waarschijnlijker maakt dan in de warmere maanden.",
    highlights: [
      "De Taj Mahal bij zonsopgang — 30 minuten met het marmer helemaal voor jezelf, voordat de drukte arriveert",
      "Nationaal park Ranthambore — twee jeepsafari's in een van de beste tijgerreservaten van India, op zoek naar tijgers, luipaarden en lippenberen langs de ruïnes van een 10e-eeuws fort",
      ...
      "De Pushkar Kamelenmarkt (alleen vertrek van 14–24 november) — het grootste volksfeest van Rajasthan, duizenden kamelen, handelaren en artiesten aan de rand van het meer",
    ...
    itinerary: [
      ...
      {
        day: 4,
        title: "De Taj Mahal bij zonsopgang — Agra → Ranthambore",
        description:
          "Vroege start: de Taj Mahal gaat 30 minuten voor zonsopgang open (de kassa's een uur eerder), en dit eerste halfuur — zacht licht, weinig mensen — is de reden waarom we de hele reis hieromheen bouwen (toegang buitenlanders ₹1.100, plus ₹200 voor het binnenste mausoleum; kinderen onder de 15 gratis; elke vrijdag gesloten, in dat geval verschuift dit bezoek naar de middag van dag 3). Na het ontbijt, vertrek naar Ranthambore (ca. 280 km, 5–5,5 uur, met een lunchstop onderweg), met inchecken in uw jungle lodge aan de rand van het nationale park in de late namiddag. Als de aankomsttijd het toelaat, direct door naar een avondlijke jeepsafari — een open 6-persoons gypsy met een natuurgids gaat het park in voor de avondploeg (toegang nationaal park en safarikosten inbegrepen; zone toegewezen door de bosbouwdienst) — tijgers, gevlekte herten en de vervallen wallen van Ranthambore Fort binnen het park, in hetzelfde goudkleurige licht dat de Taj die ochtend liet gloeien.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Zonsopgang bij de Taj, avondlijke jeepsafari in tijgergebied — twee heel verschillende kanten van India op één dag",
      },
      {
        day: 5,
        title: "Nationaal park Ranthambore — jeepsafari's bij zonsopgang en in de middag",
        description:
          "Een volledige dag rond de twee safarirondes van Ranthambore, elk in een open 6-persoons gypsy met een natuurgids (zone dagelijks toegewezen door de bosbouwdienst; toegang nationaal park en safarikosten inbegrepen). De safari bij zonsopgang vangt het park terwijl het ontwaakt — roepende langoeren, sambarherten en gevlekte herten bij de meren, en de beste kans van de dag op een tijgerwaarneming, omdat ze zich verplaatsen voordat de hitte toeslaat. Tussen de safari's door, rust in de lodge of, als de tijd het toelaat, een blik op Ranthambore Fort, een 10e-eeuws heuvelfort dat nog altijd binnen het reservaat staat, waar vanaf de muren soms de plaatselijke tijgers te zien zijn. De middagsafari gaat een andere zone in, met een goede kans op lippenberen, moerraskrokodillen en, met een beetje geluk, een van de vaste tijgers van het park. Tijgerwaarnemingen komen hier vaak voor, maar zijn nooit gegarandeerd — we geven u vooraf een eerlijk beeld van de kansen.",
        overnight: "Jungle lodge, Ranthambore",
        highlight: "Twee jeepsafari's in een van de beste tijgerreservaten van India — de ronde bij zonsopgang en in de middag",
      },
      {
        day: 6,
        title: "Ranthambore → Jaipur via de trapput van Abhaneri",
        description:
          "Een ontspannen vertrek laat in de ochtend, vanuit Ranthambore naar Jaipur (ca. 220 km via Abhaneri, 4,5–5 uur), met een stop in Abhaneri om Chand Baori te zien — de 1.200 jaar oude trapput die lokale bewoners 'baori ki haveli' noemen, waarvan de 3.500 treden in perfecte geometrische symmetrie 13 verdiepingen diep afdalen (toegang buitenlanders ca. ₹300; dagelijks open van 8 tot 18 uur). Aankomst in Jaipur aan het begin van de avond en inchecken in uw historische haveli-hotel, met de avond vrij om de sieraden- en textielstalletjes van de Johari Bazaar te verkennen.",
      ...
      },
      {
        ...
        description:
          "Een vroeg vertrek uit Pushkar (ca. 400 km terug naar Delhi, 7,5–8 uur over de weg — we starten om 7 uur om dit comfortabel te houden, met een echte lunchpauze). In Delhi, directe transfer naar de luchthaven voor uw aansluitende vlucht naar Varanasi (ca. 1,5 uur; meerdere avondvluchten per dag). Aankomst in Varanasi en transfer naar uw historische hotel in de oude stad, gekozen voor het rivieruitzicht vanaf het dakterras en de loopafstand tot de ghats. Als tijd en energie het toelaten, een optionele korte wandeling naar Dashashwamedh Ghat voor de avondlijke Ganga Aarti; anders een rustig avondeten en een vroege avond na een lange reisdag. (Deze Varanasi-verlenging is optioneel — reizigers die een kortere reis verkiezen, kunnen de reis al op dag 9 in Delhi beëindigen; zie de reistips.)",
      ...
      },
      {
        ...
        title: "Vertrek",
        description:
          "Een ontspannen laatste ochtend voor uw transfer naar de internationale luchthaven van Delhi. Ons team bevestigt vooraf de gegevens van uw retourvlucht en blijft bereikbaar tot u heeft ingecheckt. U vertrekt met de Taj bij zonsopgang, tijgers in Ranthambore, een trapput zoals nergens thuis, kamelen op een woestijnmeer en — als u de verlenging heeft toegevoegd — de oudste stad op aarde, waar het eeuwige vuur nog altijd brandt aan de oever van de rivier.",
        overnight: "—",
        highlight: "Een laatste koffie voor de luchthaven — twaalf dagen samengebald in alles wat u wilde zien",
      },
    ],
    inclusions: [
      "11 overnachtingen: 2× boutique hotel Delhi + 1× boutique hotel Agra + 2× jungle lodge Ranthambore + 2× historisch haveli-hotel Jaipur + 1× historisch gasthuis Pushkar + 2× historisch hotel Varanasi + 1× hotel bij de luchthaven van Delhi (tweepersoonskamer)",
      "Privé airconditioned voertuig voor alle bezichtigingen en wegtransfers (Delhi–Agra–Ranthambore–Jaipur–Pushkar–Delhi)",
      ...
      "2 gedeelde jeepsafari's (gypsy) in Nationaal park Ranthambore met natuurgids, inclusief toegang nationaal park en safarikosten",
      "Stop bij Chand Baori (trapput van Abhaneri) op de rit Ranthambore–Jaipur",
      ...
      "11 ontbijten + 10 avondmaaltijden",
    ...
    exclusions: [
      ...
      "Upgrade naar privé (niet-gedeelde) jeepsafari in Ranthambore (optioneel, ca. ₹3.000–5.000 extra per voertuig per safari)",
      "Kashi Vishwanath Sugam/VIP-darshan (optioneel, ca. ₹250)",
      "Lunches tijdens de reis (budget ₹500–800 per maaltijd)",
      "Persoonlijke uitgaven: winkelen, fooien, drankjes",
      "Optie olifant/jeep bij Amber Fort of extra kamelenritten boven op de vermelde onderdelen",
      "Reis- en medische verzekering (sterk aanbevolen)",
      "5% GST over de totale pakketprijs",
    ],
    pricing: [
      { label: "Tweepersoonskamer — Standaard, met Varanasi (vanaf Delhi)", priceUSD: 2399, priceINR: 228500 },
      { label: "Tweepersoonskamer — Premium, met Varanasi (vanaf Delhi)", priceUSD: 2799, priceINR: 272000 },
      { label: "Tweepersoonskamer — Standaard, zonder Varanasi, 9 dagen (vanaf Delhi)", priceUSD: 1799, priceINR: 174000 },
    ],
    departures: [
      "17 – 27 oktober 2026 (vaste groepsvertrek)",
      "14 – 24 november 2026 (vaste groepsvertrek — Pushkar Kamelenmarkt Special)",
      "28 november – 8 december 2026 (vaste groepsvertrek)",
      "19 – 29 december 2026 (vaste groepsvertrek)",
      "16 – 26 januari 2027 (vaste groepsvertrek)",
      "13 – 23 februari 2027 (vaste groepsvertrek)",
      "13 – 23 maart 2027 (vaste groepsvertrek)",
